...
def test_interpolation(cfg):
    ...
    interpolated_model_05 = interpolate_models(
        model_1=model_1, model_2=model_2, alpha=0.5
    )
    interpolated_model_1 = interpolate_models(
        model_1=model_1, model_2=model_2, alpha=1.0
    )
    ...
    diff_weights = False
    for param1, param2, param_0, param_05, param_1 in zip(
        params_model_1, params_model_2, params_int_0, params_int_05, params_int_1
    ):
